...
import { MatingEntryFilter } from "./Entities"

const DASHBOARD_BASE = 'reproduction/mating/dashboard/'
const GROUP_BASE = 'reproduction/mating/groups/'
const ENTRY_BASE = 'reproduction/mating/entries/'
const BULLS_BASE = 'reproduction/mating/bulls/'
...
export function getEntriesPage(filter: MatingEntryFilter) {
